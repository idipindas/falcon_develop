...
const contactData = {
  title: "Get In Touch",
  description:
    "Get In Touch Lorem ipsum dolor sit amet, consectetur adipiscing elit. Ullam, velit rutrum dictum lobortis turpis.",
  ...
  mapImage: "/images/World-map-vectors23.jpg",
};
