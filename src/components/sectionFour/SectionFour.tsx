        ...
        <div className="bg-white bg-opacity-10 backdrop-blur-md rounded-lg shadow-lg p-6 sm:p-8 md:p-10 lg:p-12 w-full max-w-md md:max-w-lg lg:max-w-xl">
          ...
          <form className="space-y-4 sm:space-y-6 md:space-y-8">
            ...
            <select className="w-full p-2 sm:p-3 md:p-4 text-base md:text-lg border border-white rounded-md bg-white bg-opacity-20 text-white focus:outline-none focus:ring-2 focus:ring-white">
              ...
              <option value="air_freight" className="text-gray-800">Air Freight</option>
              <option value="ocean_freight" className="text-gray-800">Ocean Freight</option>
              <option value="land_transport" className="text-gray-800">Land Transport</option>
            </select>
            <button
              type="submit"
              className="w-full bg-orange-700 hover:bg-orange-600 transition-colors duration-300 rounded-full text-white py-2 sm:py-3 md:py-4 text-base md:text-lg font-semibold"
            >
              Request
            </button>
          </form>
