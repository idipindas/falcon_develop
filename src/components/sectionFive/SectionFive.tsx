      ...
      <div className="space-y-6">
        {solutions.map((solution, index) => (
          <div
            ...
            } border-gray-300 grid grid-cols-1 sm:grid-cols-3 gap-4 items-center`}
          >
            <h2
              ref={(el) => {
                numberRefs.current[index] = el;
              }}
              className={`text-5xl md:text-6xl lg:text-7xl font-bold text-orange-500 mb-2 text-center sm:text-left ${
            ...
            <h3
              ...
              className={`text-lg md:text-2xl font-semibold text-white mb-2 text-center sm:text-left ${
                isMounted ? "" : "hidden" // Only show if mounted
              }`}
            >
              {solution.title}
            </h3>
            <p className="text-gray-300 text-sm md:text-base text-center sm:text-left">
